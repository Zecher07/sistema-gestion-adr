...
import { LayoutList, Kanban as KanbanIcon, CheckCircle2, Search, ChevronLeft, ChevronRight, Play, PackageSearch, PackageCheck, FileSignature, AlertOctagon, Wallet, DollarSign, Globe, Wrench, ShoppingCart } from 'lucide-react';
               ...
               <table className="w-full text-sm text-left">
                  <thead className="text-xs text-slate-700 font-bold border-b border-slate-200 bg-white">
                     <tr>
                        ...
                        {/* 🔥 EL ADMIN Y CONTABILIDAD VEN LA COLUMNA DE ACCIONES 🔥 */}
                        ...
                        paginatedOrders.map(order => {
                          ...
                          return (
                            <tr key={order.id} className="hover:bg-blue-50/50 transition-colors group cursor-pointer bg-white" onClick={() => onViewOrder(order)}>
                               ...
                               {/* 🔥 BOTÓN COBRAR HABILITADO PARA CUALQUIER ORDEN EN CONTABILIDAD 🔥 */}
